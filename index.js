...
async function run() {
  try {
    ...
    const productCollection = client
      ...
      .collection("products");
    const carouselCollection = client
      .db("manufacturerWebsite")
      .collection("carousels");
    const hammerPhotosCollection = client
      .db("manufacturerWebsite")
      .collection("hammerPhotos");
    const reviewCollection = client
      .db("manufacturerWebsite")
      .collection("reviews");
    const userOrdersCollection = client
      .db("manufacturerWebsite")
    ...
    app.put("/review/:email", async (req, res) => {
      ...
      const usersReview = await reviewCollection.updateOne(
        filter,
        updateDoc,
        options
      );
    ...
    app.patch("/userOrder/:id", async (req, res) => {
      ...
      const updateUserOrder = await userOrdersCollection.updateOne(
        filter,
        updateDoc
      );
      res.send(updateDoc);
